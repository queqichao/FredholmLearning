...
results[1] = classifier_help.evaluation_classifier(data, classifiers[1], True, 5, fit_params={"kernel_training_data": image_data.to_array().astype(np.float)})

classifiers[2]["n_jobs"] = 1
results[2] = classifier_help.evaluation_classifier(data, classifiers[2], True, 5, fit_params={"kernel_training_data": image_data.to_array().astype(np.float)})

classifiers[3]["n_jobs"] = 1
results[3] = classifier_help.evaluation_classifier(data, classifiers[3], True, 5)
