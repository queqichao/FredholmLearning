...
class RBFKernelRegression(BaseEstimator, TransformerMixin):
  ...
  def from_bin_file(filename):
    ...
    return RBFKernelRegression(dictionary, gamma, eta)
...
class RBFKernelApprClassifier(RidgeClassifier):
  ...
  def __init__(self, kernel_approximating_method=None, dictionary_file=None, gamma=None, eta=None, dictionary_parm=None, subsample=None, n_components=None, random_state=None, alpha=None, fit_intercept=None):
    self.kernel_approximator = RBFKernelRegression(dictionary_file=dictionary_file, gamma=gamma, eta=eta, dictionary_parm=dictionary_parm, subsample=subsample)
    self.alpha = alpha
  ...
  def set_params(self, **params):
    ...
    sub_params = {}
    for name in RBFKernelRegression._get_param_names():
      if name in params:
